...
jvm.WorldMap.prototype = {
    ...
    applyTransform: function() {
        ...
        this.container.trigger('viewportChange', [this, this.scale/this.baseScale, this.transX, this.transY]);
    },
    ...
    setScale: function(scale, anchorX, anchorY, isCentered) {
        ...
        this.scale = scale;
        this.applyTransform();
        this.container.trigger(viewportChangeEvent, [this, scale/this.baseScale]);
    },
